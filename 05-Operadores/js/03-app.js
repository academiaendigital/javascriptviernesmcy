...
// En javascript existen diferentes tipos de datos primitivos 
// a los que hemos visto, además de string y number 
// se tienen booleans que son true o false,  y existen
//  un par más llamados undefined y null


// veamos un ejemplo de undefined.
let numero;

console.log(numero); // La variable esta definida pero su valor no, por lo 
// tanto es undefined...
...
let numero2 = null;
console.log(numero2);
console.log(typeof numero2); // ahora esto nos dirá que es un objeto, 
// la especificación de ecma que es quien define el standard del lenguaje dice que null debe ser un objeto
